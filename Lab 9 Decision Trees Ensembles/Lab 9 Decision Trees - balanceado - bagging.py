...
trees = DecisionTreeClassifier(criterion='gini', splitter='best', max_depth=None, min_samples_split=2, min_samples_leaf=1)

bags=BaggingClassifier(base_estimator=trees, n_estimators=10, n_jobs=1, verbose=1)
